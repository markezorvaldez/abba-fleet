...
5. Create and checkout the feature branch using the ticket's `gitBranchName` field (e.g. `git checkout -b feature/mar-15`). If the branch already exists, check it out without `-b`.
6. Proceed with planning and implementation.
