...
public class NoteServiceTests
{
    ...
    private NoteService CreateService() => new(_repository, _authStateProvider, _logger);
    ...
    public async Task CreateNoteAsync_ValidInput_ReturnsSuccessAndAddsToRepository()
    {
        ...
        await _repository.Received(1).AddAsync(Arg.Is<Note>(n =>
    ...
    public async Task UpdateNoteAsync_ValidInput_ReturnsSuccessAndCallsRepository()
    {
        ...
        await _repository.Received(1).UpdateAsync(Arg.Is<Note>(n =>
            n.Id == existingNote.Id &&
            n.Title == newTitle &&
            n.Body == newBody &&
            n.ModifiedBy == _userName));
    }
