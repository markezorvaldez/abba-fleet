...
public class AttachedFile
{
    ...
    public AttachedFile(Guid? noteId, NoteEntityType entityType, Guid entityId,
        string fileName, long fileSize, string contentType, string storagePath, string uploadedBy)
    {
        ...
        ArgumentException.ThrowIfNullOrWhiteSpace(uploadedBy, nameof(uploadedBy));
