...
public interface IUserService
{
    ...
    Task<UserResult> UpdateAsync(string userId, string fullName, bool isActive, string? newPassword, IReadOnlySet<Permission> targetPermissions, string currentUserId);
